...
<img src="https://komarev.com/ghpvc/?username=TiagoBorba013&label=PROFILE%20VIEWS&color=00e5ff&style=for-the-badge" alt="Profile Views"/>
...
```text
╔══════════════════════════════════════════════════════════════╗
║                    A.I. DEVELOPER PROFILE                   ║
╠══════════════════════════════════════════════════════════════╣
║ STATUS        : ONLINE                                       ║
║ IDENTITY      : TIAGO SOUSA DE BORBA                        ║
║ ROLE          : INFORMATION SYSTEMS STUDENT                ║
║ UNIVERSITY    : PUC MINAS                                   ║
║ CURRENT LEVEL : 2nd PERIOD                                  ║
...
Sou estudante de **Sistemas de Informação na PUC Minas**, atualmente no **2º período**, e estou construindo minha jornada no desenvolvimento de software.

Tenho conhecimentos em **HTML, CSS, JavaScript e C#**, além de fundamentos de **Front-end, Back-end e Banco de Dados**.

Atualmente estou focado em transformar conhecimento acadêmico em projetos práticos, evoluindo minha lógica de programação, minhas habilidades de desenvolvimento e minha capacidade de construir aplicações cada vez mais completas.

Meu objetivo é continuar aprendendo, desenvolvendo projetos e evoluindo constantemente como profissional da tecnologia.

```yaml
developer:
  name: "Tiago Sousa de Borba"
  username: "TiagoBorba013"
...
[■■■■■■■■■■■■■■■■■■■■] 100%  → Evoluir fundamentos de programação
[■■■■■■■■■■■■■■■■■□□□]  85%  → Aprofundar JavaScript
[■■■■■■■■■■■■■■□□□]  75%  → Evoluir em C#
[■■■■■■■■■■■■■■□□□]  70%  → Banco de Dados / SQL
[■■■■■■■■■■■■□□□]  65%  → Desenvolvimento Back-End
[■■■■■■■■■■■■□□□]  60%  → Desenvolvimento Full Stack
[■■■■■■■■■■□□□]  50%  → Inglês técnico

> NEXT_TARGET: BUILD → DEPLOY → LEARN → REPEAT
...
<picture>
  ...
  <source
    ...
    srcset="https://raw.githubusercontent.com/TiagoBorba013/TiagoBorba013/output/github-contribution-grid-snake.svg"
  />
  <img
    src="https://raw.githubusercontent.com/TiagoBorba013/TiagoBorba013/output/github-contribution-grid-snake.svg"
